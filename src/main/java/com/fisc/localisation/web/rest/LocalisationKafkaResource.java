...
@RestController
@RequestMapping("/api/localisation-kafka")
public class LocalisationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LocalisationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LocalisationKafkaResource(KafkaProperties kafkaProperties) {
